...
public final class PanMainSports extends JPanel implements ActionListener {
    ...
    String sJson;
    JSONObject obj;
    public int i = 1, nRight = 0, nWrong = 0;
    FileReader reader;
    JSONParser parser;
    JLabel qlbl, lbl;
    JLabel timerLbl;
    ...
    public PanMainSports() throws Exception {
        filePath = "src\\TriviaGame\\Sports.json";
