...
public final class PanMainPolitics extends JPanel implements ActionListener {
    ...
    public PanMainPolitics() throws Exception {
        filePath = "src\\TriviaGame\\Politics.json";
